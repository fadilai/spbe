            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="section-title pt-4">
                        ...
                        <img src="{{ asset('spbe_template/images/icon_tentang.svg') }}" alt="Deskripsi gambar" class="img-fluid mt-4">
                    </div>
                </div>
                            ...
                            <div class="service-item">
                                <a class="text-black" href="service-details.html">
                                    <div class="block">
                                        ...
                                        <h3 class="mb-3 service-title">Kebijakan SPBE</h3>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="section-title">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Consv allis quam aliquet integer eget
                            magna
                ...
                <div class="col-lg-7 text-center text-lg-end">
                    <img loading="lazy" decoding="async" src="{{ asset('spbe_template/images/about-us.png') }}"
